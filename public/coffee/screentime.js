...
(function() {
  (function(factory) {
    ...
    $.screentime = function(options) {
      var Field, Viewport, cache, checkViewport, classicGA, counter, init, log, looker, onScreen, random, report, sendGAEvent, startTimers, started, stopTimers, universalGA;
      random = function() {
